...
def main():
    ...
    ax.set_title("STCO Thermal Waterfall — φ-HBM vs all-DRAM (30 × 22 mm), active read/write\n"
                 "GPU compute-die peak (step lines); lowest DRAM tier in the filled box by each GPU number",
