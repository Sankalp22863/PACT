# EXP_INV_NVDRAM_100 — inverted stack (GPU on top), 100% GPU (414 W)
...
with the new `--invert` flag; GPU at 100% GPU (414 W). Memory = standby power (NVDRAM leakage only, --bw-util 0).
...
Run:  `python3 ../scripts/run_experiment.py ../EXP_INV_NVDRAM_100`
