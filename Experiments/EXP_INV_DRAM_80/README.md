# EXP_INV_DRAM_80 — inverted stack (GPU on top), 80% GPU / 0.8x freq (368 W)
...
with the new `--invert` flag; GPU at 80% GPU / 0.8x freq (368 W).
...
Run:  `python3 ../scripts/run_experiment.py ../EXP_INV_DRAM_80`
